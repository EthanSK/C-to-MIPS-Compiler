...
%type <exprList> INIT_DECLARATOR_LIST PARAMETER_TYPE_LIST TYPE_QUALIFIER_LIST INITIALIZER_LIST
...
INIT_DECLARATOR
	...
	| DECLARATOR T_EQ T_LCURLY_BRACE INITIALIZER_LIST T_RCURLY_BRACE { $$ = new ArrayInitDeclarator($1, new InitializerList(*$4)); delete $4; }
	;
...
TYPE_QUALIFIER_LIST
	: TYPE_QUALIFIER { $$ = initExprList($1); }
	| TYPE_QUALIFIER_LIST TYPE_QUALIFIER { $$ = concatExprList($1, $2); }
	;
...
INITIALIZER
	: ASSIGNMENT_EXPRESSION
	//Removed because we aren't supporting 2D arrays
...
INITIALIZER_LIST
	...
	| INITIALIZER_LIST T_COMMA INITIALIZER { $$ = concatExprList($1, $3); }
	;

STATEMENT
	: LABELED_STATEMENT //switch statements
